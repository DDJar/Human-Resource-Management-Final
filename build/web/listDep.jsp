            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <form action="search-department" method="post">
                            <div class="row">
                                ...
                                <div class="col-sm-1" style="padding-left:14%;padding-right: 10%;" >
                                    <select class="section-bg" name="sCriteria">  
                                        ...
                                        <option value="did" ${sCriteria == "did" ? "selected" : ""}> ID</option>
                                        <option value="dname"${sCriteria == "dname" ? "selected" : ""}>Name</option>
                                    </select></div>
                    ...
                    <div style="float: right;">
                        <c:if test="${role =='MN' }">
                            <a href="addnewDep.jsp" class="view" type="button" title="Add" data-toggle="tooltip"> <button class="btn btn-primary" type="button">ADD</button></a>
                        </c:if>
                        <c:if test="${role =='ST' }">
                            <a href="addnewDep.jsp" class="view" type="button" title="Add" data-toggle="tooltip"> <button class="btn btn-primary" type="button">ADD</button></a>
                        </c:if>
                    ...
                    <table class="table table-striped table-hover table-bordered" style="width: 50%;margin-left: 30%" >
                        <thead>
                        ...
                        <c:forEach var="o" items="${listA}" >
                            <tbody>
                                <tr>
                                    ...
                                    <c:if test="${role =='MN' }">
                                        <td>
                                            <a href="delete-department?did=${o.getDid()}" class="delete" type="button" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                                        </c:if>
                                        <c:if test="${role =='ST' }">
                                        <td>
                                            <a href="delete-department?did=${o.getDid()}" class="delete" type="button" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                    ...
                    <div style="float: end; width: 80%">
                        <table border="2" cellpadding="5" cellspacing="5" style="border-color:#03A9F4" >
                            <tr>
                                <c:if test="${tag > 1}">
                                    <td ><a href="list-department?page=${tag-1}"> Previous</a> <td>
                                    </c:if>
                                    <c:forEach begin="1" end="${endPage}" var="i">
                                    <td style="border-color: #03A9F4;border-width: 1px;padding-right:10px"> <a class="${tag==i? "active" : ""}" href="list-department?page=${i}"> ${i}</a>
                                    </c:forEach> 
                                </td>
                                <c:if test="${tag < endPage}">
                                    <td> <a  href="list-department?page=${tag+1}"> Next</a> <td>
                                    </c:if>
                            </tr>
                        </table>
                    </div>               
