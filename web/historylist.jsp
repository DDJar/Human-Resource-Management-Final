                ...
                <div class="table-wrapper">
                                        ...
                                        <tr>
                                            ...
                                            <c:if test="${role =='MN' }">
                                                <td>
                                                    ...
                                                    <a href="permanently-delete?id=${o.getUserID()}" class="delete" type="button" title="Delete" data-toggle="tooltip">Unclock</a>
                                                </c:if>
                                                <c:if test="${role =='ST' }">
                                                <td>
                                                    <a href="update-list?id=${o.getUserID()}" class="view" type="button" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                    ...
                    <div  style="float: end; width: 80%">
                        <table border="2" cellpadding="5" cellspacing="5" style="border-color:#03A9F4" >
                            <tr>
                                <c:if test="${tag > 1}">
                                    <td ><a href="history-list?page=${tag-1}"> Previous</a> <td>
                                    </c:if>
                                    <c:forEach begin="1" end="${endPage}" var="i">
                                    <td style="border-color: #03A9F4;border-width: 1px;padding-right:10px"> <a class="${tag==i? "active" : ""}" href="history-list?page=${i}"> ${i}</a>
                                    </c:forEach> 
                                </td>
                                <c:if test="${tag < endPage}">
                                    <td> <a  href="history-list?page=${tag+1}"> Next</a> <td>
                                    </c:if>
                            </tr>
                        </table>
                    </div>               
